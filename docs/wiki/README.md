...
| 决策树 | OpenViking `projects/context-assembler/design/decision-points/`（119 节点，v4.x） | `docs/wiki/decisions/`（30 页，v0.x~v5.8，含旧树聚合） |
| 架构设计 | `docs/design/`（7 个独立文档） | 已合并入 `docs/wiki/architecture/` |
