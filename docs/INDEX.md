...
| # | 文件 | 版本引入 | 源文件 | 说明 |
|---|------|----------|--------|------|
| 01 | [概览](architecture/01-overview/01-overview.md) | v6.0 | — | 系统架构、模块依赖、术语 |
...
| 05 | [A-stage 装配](architecture/05-a-stage/05-a-stage.md) | v6.0 | `ca/a_stage.py` | direction B：DB 重建 conv_history（含 tail-protection）；select_context 每轮驱动、生产已激活（CE 壳注册恢复，见决策 20 修订） |
...
| # | 文件 | 版本 | 决策类型 | 影响组件 |
|---|------|------|----------|----------|
| 01 | [设计哲学](decisions/01-design-philosophy/01-design-philosophy.md) | v0.x | 架构基础 | 全系统 |
| 02 | [三阶段架构](decisions/02-three-stage-arch/02-three-stage-arch.md) | v4.3 | 架构 | 管线 |
...
| 06 | [方向 B](decisions/06-direction-b/06-direction-b.md) | v6.0 | 架构重写 | a-stage, topic mgmt（select_context 驱动，生产已激活，2026-08-15 修订） |
...
| 20 | [CE 壳注册](decisions/20-ce-shell-registration/20-ce-shell-registration.md) | v5.10 | 插件 | plugin（1 参注册 + select_context 驱动，生产已激活 2026-08-15） |
...
| **35** | **[Strand 多事务摘要](decisions/35-strand-multi-affair-summarization/35-strand-multi-affair-summarization.md)** | v6.4 | 摘要 | strand_summaries, topic_summary |
| **36** | **[Wiki Theme 生成重构](decisions/36-theme-wiki-generation/36-theme-wiki-generation.md)** | v6.5 | 归并 | theme, store |
...
| **45** | **[多事务 OODA 记录单一化（v3：去掉【已完成】等标签）](decisions/45-multi-affair-ooda-record/45-multi-affair-ooda-record.md)** | v6.1 | F/strand | prompts, fct_multi_affair, topic_summary, store, f_stage, a_stage |

## 相关资源

| 资源 | 位置 | 说明 |
|------|------|------|
| **OV 决策树（全量）** | OV `projects/context-assembler/decisions/decision-points/` | 141+ 独立决策节点（完整追溯） |
