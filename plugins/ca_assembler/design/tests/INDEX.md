...
> 决策树主入口: `design/decision-points-wiki.md`
> 参见: `design/decision-points/INDEX.md`
> 测试体系重构报告: `design/test-system-refactoring-v5.0.md`（如存在）
...
- `design/decision-points-wiki.md` — 决策树主入口（含测试套件对照→本节）
- `design/decision-points/INDEX.md` — 节点索引
